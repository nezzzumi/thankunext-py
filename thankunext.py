...
if not (build_manifest_path := re.search(r'/_next/static/[a-zA-Z0-9]+/_buildManifest\.js', response.text)):
...
paths = re.findall(r'(?<=\")[a-zA-Z0-9_/\[\]\.]+(?=\")', build_manifest_response.text)
